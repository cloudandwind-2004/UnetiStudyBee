                ...
                http
                                ...
                                .authorizeHttpRequests(
                                                authz -> authz
                                                                ...
                                                                .requestMatchers(mvc.pattern("/api/users/*")).hasAnyAuthority(AuthoritiesConstants.ADMIN, AuthoritiesConstants.STUDENT, AuthoritiesConstants.TEACHER)
                                                                .requestMatchers(mvc.pattern("/api/users/upd/*")).hasAnyAuthority(AuthoritiesConstants.ADMIN, AuthoritiesConstants.STUDENT, AuthoritiesConstants.TEACHER)
                                                                .requestMatchers(mvc.pattern("/api/users/*/avatar")).hasAnyAuthority(AuthoritiesConstants.ADMIN, AuthoritiesConstants.STUDENT, AuthoritiesConstants.TEACHER)
